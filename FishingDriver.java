...
public class FishingDriver {
   ...
   */
   public static void main(String[] args) {
      ...
      FishingDriver.growFish(lokoi_a, 24);
   ...
   */
   public static void growFish(ArrayList<FishableI_a> al, int months) {
      FishableI_a ia;
   ...
   public static void lawai_a(ArrayList<FishableI_a> fishPond) {
      ...
      //Randomly caught or not.
         ...
         if (isCaught) {
            ...
            fishPond.remove(chosenFish); //Remive fish from pond.
            if (ia.isLegalSize()) {
